...
export const tools = [
  ...
  // --- Complex tools ---
  {
    ...
    description: "Generate TypeScript interfaces from a JSON sample, with nested objects and arrays inferred.",
    icon: FileType,
    category: "converters",
  },
  {
    slug: "json-diff",
    title: "JSON Diff",
    description: "Compare two JSON documents and see exactly which keys and values were added, removed, or changed.",
    icon: FileDiff,
    category: "text",
  },
  {
    ...
    description: "Group and aggregate a CSV by one or more columns, right in your browser.",
  ...
  },
  {
    ...
    description: "Compute a file's SHA-256/512 checksum and verify it against an expected value, without uploading it.",
    icon: FileCheck,
    category: "security",
  },
  {
    ...
    description: "Pull the dominant colors out of an image and copy them as hex, RGB, or CSS variables.",
    icon: Pipette,
    category: "design",
  },

  // --- Hosted open-source projects ---
  {
    slug: "whiteboard",
    title: "Whiteboard",
    description: "Sketch diagrams, wireframes, and hand-drawn-style notes on an infinite canvas, powered by Excalidraw.",
    icon: PenTool,
    category: "design",
  },
  {
    slug: "json-editor",
    title: "JSON Editor",
    description: "View, edit, and validate JSON in a tree, table, or text view, with JSON Schema support.",
    icon: ListTree,
    category: "encoding",
  },
  {
